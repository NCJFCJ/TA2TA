 ...
 * Event_manager model
 */
class Event_managerModelvideo extends JModelAdmin{
	/**
	 * @var		string	The prefix to use with controller messages
	 * @since	1.6
	 */
	protected $text_prefix = 'COM_EVENT_MANAGER';
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Video', $prefix = 'Event_managerTable', $config = array()){
	...
	public function getForm($data = array(), $loadData = true){
		...
		// Get the form.
		$form = $this->loadForm('com_event_manager.video', 'video', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	protected function loadFormData(){
		...
		$data = JFactory::getApplication()->getUserState('com_event_manager.edit.video.data', array());
