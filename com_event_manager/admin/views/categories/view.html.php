 ...
 */
class Event_managerViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Event_managerHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENT_MANAGER_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_event_manager&view=categories');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_EVENT_MANAGER_CATEGORIES_NAME')
		);
	}
