 ...
 * View to edit
 */
class Event_managerViewCategory extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= Event_managerHelper::getActions();

		JToolBarHelper::title(JText::_('COM_EVENT_MANAGER_TITLE_CATEGORY'), 'category.png');
