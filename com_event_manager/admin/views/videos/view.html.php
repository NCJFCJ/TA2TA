...
/**
 * View class for a list of Event_manager.
 */
class Event_managerViewVideos extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Event_managerHelper::addSubmenu('videos');
	...
	protected function addToolbar()
	{
		...
		$canDo	= Event_managerHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_EVENT_MANAGER_TITLE_VIDEOS'), 'videos.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_event_manager');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_event_manager&view=videos');
        ...
        $form = JForm::getInstance('com_event_manager.video', 'video');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_EVENT_MANAGER_VIDEOS_TITLE'),
		'a.category' => JText::_('COM_EVENT_MANAGER_VIDEOS_CATEGORY'),
		);
	}
