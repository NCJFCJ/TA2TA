 ...
 */
class Event_managerModelVideo extends JModelList{
    ...
    public function getCategories(){
        ...
        $query->from($db->quoteName('#__event_manager_categories'));
    ...
    public function getVideo(){
        ...
        $query->from($db->quoteName('#__event_manager'));
    ...
    public function getVideos(){
        ...
        $query->from($db->quoteName('#__event_manager', 'v'));
        $query->join('LEFT', $db->quoteName('#__event_manager_categories', 'c') . ' ON ' . $db->quoteName('c.id') . '=' . $db->quoteName('v.category'));
