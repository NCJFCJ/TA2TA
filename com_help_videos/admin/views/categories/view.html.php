 ...
 */
class Help_videosViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Help_videosHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_HELP_VIDEOS_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_help_videos&view=categories');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_HELP_VIDEOS_CATEGORIES_NAME')
		);
	}
