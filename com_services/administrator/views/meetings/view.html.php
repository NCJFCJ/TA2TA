 ...
 */
class ServicesViewMeetings extends JViewLegacy{
	protected $items;
	...
	public function display($tpl = null){
		...
		ServicesHelper::addSubmenu('meetings');
	...
	protected function addToolbar(){
		...
		JToolBarHelper::title(JText::_('COM_SERVICES_TITLE_MEETINGS'), 'meetings.png');
    ...
    //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_services&view=meetings');
