...
if($_SERVER['REQUEST_METHOD'] == 'POST'
	...
	$userOrg = ServicesHelper::getUserOrg();
	
	//lose any special characters in the filename
	$file->name = strtolower(preg_replace('/[^A-Za-z0-9]/i', '-', substr($userOrg->name,0,46))) . '.' . $filePathInfo['extension'];

	// construct the file path
	$uploadPath = JPATH_SITE . '/media/com_services/tmp/' . $file->name;
