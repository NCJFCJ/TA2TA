...
class Ta_calendarTableevent extends JTable{
    ...
    public function bind($array, $ignore = ''){
      ...
      if(!JFactory::getUser()->authorise('core.admin', 'com_ta_calendar.event.'.$array['id'])){
          $actions = JFactory::getACL()->getActions('com_ta_calendar','event');
          $default_actions = JFactory::getACL()->getAssetRules('com_ta_calendar.event.'.$array['id'])->getData();
          $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_ta_calendar.event.' . (int) $this->$k;
    }
