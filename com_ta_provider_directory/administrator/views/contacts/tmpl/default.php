...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_ta_provider_directory&task=contacts.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_ta_provider_directory&view=contacts'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="contactList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_TA_PROVIDER_DIRECTORY_CONTACTS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
