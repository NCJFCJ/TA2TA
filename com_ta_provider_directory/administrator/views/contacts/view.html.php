 ...
 */
class Ta_provider_directoryViewContacts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ta_provider_directoryHelper::addSubmenu('contacts');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_TA_PROVIDER_DIRECTORY_TITLE_CONTACTS'), 'contacts.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_ta_provider_directory&view=contacts');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_TA_PROVIDER_DIRECTORY_CONTACTS_CREATED_BY'),
		);
	}
