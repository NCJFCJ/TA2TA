...
<form action="<?php echo JRoute::_('index.php?option=com_ta_provider_directory&view=providers'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="providerList">
			...
			<tr>
				<td colspan="<?php echo $colspan ?>" class="center">
					<?php echo JText::_('COM_TA_PROVIDER_DIRECTORY_PROVIDERS_NO_RECORDS'); ?> <a href="/administrator/index.php?option=com_ta_provider_directory&view=provider&layout=edit"><?php echo JText::_('COM_TA_PROVIDER_DIRECTORY_ADD_NEW'); ?></a>
				</td>
			</tr>
			<?php else:
			foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_ta_provider_directory&task=provider.edit&id='.(int) $item->id); ?>">
