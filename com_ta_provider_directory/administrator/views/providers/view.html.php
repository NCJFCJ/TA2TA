...
/**
 * View class for a list of Ta_provider_directory.
 */
class Ta_provider_directoryViewProviders extends JViewLegacy{
	protected $items;
	...
	public function display($tpl = null){
		...
		Ta_provider_directoryHelper::addSubmenu('providers');
	...
	protected function addToolbar(){
		...
		$canDo	= Ta_provider_directoryHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_TA_PROVIDER_DIRECTORY_TITLE_PROVIDERS'), 'providers.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_ta_provider_directory');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_ta_provider_directory&view=providers');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_TA_PROVIDER_DIRECTORY_PROVIDERS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_TA_PROVIDER_DIRECTORY_PROVIDERS_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_TA_PROVIDER_DIRECTORY_PROVIDERS_NAME'),
		'a.created_by' => JText::_('COM_TA_PROVIDER_DIRECTORY_PROVIDERS_CREATED_BY'),
		);
	}
