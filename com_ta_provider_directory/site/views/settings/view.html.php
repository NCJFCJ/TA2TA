 ...
 * View to edit
 */
class Ta_provider_directoryViewSettings extends JViewLegacy {
    protected $state;
    protected $form;
	protected $listing;
    protected $params;
	...
	protected function _prepareDocument(){
		...
		if($menu){
			...
			$this->params->def('page_heading', JText::_('COM_TA_PROVIDER_DIRECTORY_SETTINGS_TITLE'));
		}
