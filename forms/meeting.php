		...
		<div class="row">
			<div class="col-sm-5">
				<fieldset>
					...
					<input type="hidden" id="serviceType" name="serviceType" value="meeting">
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="grant">Grant Number</label>
						<div class="col-sm-8">
							<input type="text" id="grant" name="grant">
						</div>
					</div>
				</fieldset>
			</div>
			<div class="col-sm-offset-1 col-sm-5">
				<fieldset>
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="title">Title of Meeting/Subject</label>
						<div class="col-sm-8">
							<input type="text" id="title" name="title">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="dates">Date(s) of Meeting</label>
						<div class="col-sm-8">
							<input type="text" id="dates" name="dates">
						</div>
					</div>
					<div class="form-group">
						<label for="description">Please describe the type of assistance you are requesting:</label>
...
<script type="text/javascript">
	jQuery(function($){
		$('.service-form').submit(function(event){
			...
			// variables
			var fields = new Array('#serviceType', '#fullName', '#email', '#organization', '#phone', '#project', '#grant', '#title', '#dates', '#description');
