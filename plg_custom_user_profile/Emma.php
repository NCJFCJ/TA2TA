<?php
	...
	class Emma {
		...
		*/
		protected $_account_id = '12532';
		/**
		* Cache the user public key for API usage
		*/
		protected $_pub_key = '3e9b98558885a253f47b';
		/**
		* Cache the user private key for API usage
		*/
		protected $_priv_key = 'd2d11ab5915aab55bfd1';
		/**
		...
		* @param boolean $debug	Whether to show debug messages or not
		* @access public
		*/
