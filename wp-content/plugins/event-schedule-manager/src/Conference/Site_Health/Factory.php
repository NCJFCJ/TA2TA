...
class Factory {
	...
	public function get_sections(): array {
		/**
		 * Allows filtering of the Conference Info Sections.
		 *
		 * @since 1.0.0
		 *
		 * @param array<string,mixed> $sections Which sections exist.
		 */
		$sections = (array) apply_filters( 'tec_conference_debug_info_sections', [] );
	...
	public function filter_include_info_sections( array $info = [] ) {
		...
		$info = Arr::insert_after_key( $this->get_insert_after_section_key(), $info, $sections );
