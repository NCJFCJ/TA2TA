...
use stdClass;
use TEC\Conference\Site_Health\Fields\Generic_Info_Field;
...
abstract class Info_Section_Abstract implements Info_Section_Interface {
	...
	protected function filter_param( string $param, $value = null ) {
		 ...
		 */
		$value = apply_filters( "tec_conference_debug_info_section_get_{$param}", $value, $this );
		 ...
		 * @param Info_Section_Abstract $section Current Section.
		 */
		return apply_filters( "tec_conference_debug_info_section_{$section_slug}_get_{$param}", $value, $this );
	}
