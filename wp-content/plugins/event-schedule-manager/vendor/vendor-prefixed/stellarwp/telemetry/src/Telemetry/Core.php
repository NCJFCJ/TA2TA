...
namespace TEC\Conference\Vendor\StellarWP\Telemetry;

use TEC\Conference\Vendor\StellarWP\ContainerContract\ContainerInterface;
use TEC\Conference\Vendor\StellarWP\Telemetry\Admin\Admin_Subscriber;
use TEC\Conference\Vendor\StellarWP\Telemetry\Admin\Resources;
use TEC\Conference\Vendor\StellarWP\Telemetry\Contracts\Data_Provider;
use TEC\Conference\Vendor\StellarWP\Telemetry\Data_Providers\Debug_Data;
use TEC\Conference\Vendor\StellarWP\Telemetry\Events\Event_Subscriber;
use TEC\Conference\Vendor\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use TEC\Conference\Vendor\StellarWP\Telemetry\Exit_Interview\Template;
use TEC\Conference\Vendor\StellarWP\Telemetry\Last_Send\Last_Send;
use TEC\Conference\Vendor\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use TEC\Conference\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use TEC\Conference\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use TEC\Conference\Vendor\StellarWP\Telemetry\Opt_In\Status;
use TEC\Conference\Vendor\StellarWP\Telemetry\Telemetry\Telemetry;
use TEC\Conference\Vendor\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \TEC\Conference\Vendor\StellarWP\ContainerContract\ContainerInterface
	 */
