...
namespace TEC\Conference\Vendor\StellarWP\Uplink\API\V3\Auth;

use TEC\Conference\Vendor\StellarWP\Uplink\API\V3\Contracts\Client_V3;
use TEC\Conference\Vendor\StellarWP\Uplink\Traits\With_Debugging;
use WP_Error;
use WP_Http;

use function TEC\Conference\Vendor\StellarWP\Uplink\is_authorized;
