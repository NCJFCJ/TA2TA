...
?>
<div class="wrap">
	<h2><?php _e('WP Fast Total Search Options', 'fulltext-search');?></h2>
	<div class="bs-wpfts">
	...
	foreach ($tabs as $tab_key => $tab_caption) {
		...
		echo '<li class="nav-item" data-name="'.$tab_key.'"><a class="nav-link'.$active.'" href="?page='.$tab_key.'" id="wpfts_mainmenu_tab_'.$tab_key.'"><i class="'.$tab_caption[1].'"></i><span class="wpfts_menu_text"> '.$tab_caption[0].'</span></a></li>';
