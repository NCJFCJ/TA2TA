				...
				<div style="background: #f8f9fa;">
					<table class="table table-bordered table-striped">
						<tr>
							...
							<td>
							<?php echo __('The WP Fast Total Search plugin website', 'fulltext-search'); ?>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
							<?php echo __('The official Wordpress.org support page for the WP Fast Total Search plugin (only for free version)', 'fulltext-search'); ?>
							</td>
						</tr>
						<tr>
							<td>
