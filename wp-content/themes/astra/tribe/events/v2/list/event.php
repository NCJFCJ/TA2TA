		...
		<article <?php tribe_classes( $event_classes ) ?>>
			...
			<div class="tribe-events-calendar-list__event-details tribe-common-g-col" style="width: 100%">
				...
				<header class="tribe-events-calendar-list__event-header">
					...
					<?php $this->template( 'list/event/organization', [ 'event' => $event ] ); ?>
					<?php $this->template( 'list/event/website-link', [ 'event' => $event ] ); ?>
					<?php $this->template( 'list/event/registration-link', [ 'event' => $event ] ); ?>
