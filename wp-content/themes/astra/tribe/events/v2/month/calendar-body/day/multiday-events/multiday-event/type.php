...
<h3 class="tribe-events-calendar-month__calendar-event-title tribe-common-h8 tribe-common-h--alt" style="font-style:initial; font-weight:600; border-radius:5px; text-align:center; color:<?php echo $color?>; background:<?php echo $background_color?>; ">
	<?php
