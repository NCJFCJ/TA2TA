...
<input
	...
	value="<?php if($field_name == '_ecp_custom_49') { $value = $organization; } echo esc_attr( $value ); ?>"
	placeholder="<?php if($field_name == '_ecp_custom_49') { echo $organization;} ?>"
	<?php if($field_name == '_ecp_custom_49') { echo ( ' readonly' );} ?>
>
