...
<?php if ( ! empty( $fields['Registration URL'] ) ) : ?>	
		<?php echo "Registration: " ?>
		<a
			href="<?php echo esc_url( $fields['Registration URL'] ); ?>"
			title="<?php echo esc_attr( "Regristration URL" ); ?>"
			rel="bookmark"
		    target="_blank"
			class=""
		>
