...
<h3 class="tribe-events-calendar-month__calendar-event-title tribe-common-h8 tribe-common-h--alt" style="font-style:initial; width: 100%; font-weight:600; border-radius:5px; text-align:center; color:<?php echo $colors[$event_type[0]->name]['color']; ?>; background:<?php echo $colors[$event_type[0]->name]['background_color']; ?>; ">
	<?php
